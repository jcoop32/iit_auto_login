...
def loginPortal(url):
    ...
    time.sleep(5)
    goToApplication(driver)


def goToApplication(driver):
    ...
    goToRoomSelecionPage(driver)


def goToRoomSelecionPage(driver):
    time.sleep(3)
    driver.get(
